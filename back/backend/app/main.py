...
from app.routes import activity, chat, contacts, conversations, device_converse, device_pairing, discussions, gemini_stt, health, intent_classifier, settings, speakers, stt_token, summaries, wakeword
